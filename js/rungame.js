...
function renderSketchpad() {
  ...
  var div = document.getElementById('currentRound');
...
function renderTextPhrase() {
  ...
  console.log(localStorage.getItem('formPhrase' + roundCount));
  printTextPhrase.textContent = localStorage.getItem(
    'formPhrase' + roundCount);
...
function renderNextSketchButton() {
  ...
  document
    ...
    .addEventListener('click', generateSketchPadPage());
